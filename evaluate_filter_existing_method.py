...
files = [
    'results_filter_existing_method/filter_existing_method.csv',
    'results_filter_existing_method/filter_existing_method_concept.csv',
]
...
with open('output_table_filter_existing_method.txt', 'w') as f:
    f.write('\n'.join(table_data))