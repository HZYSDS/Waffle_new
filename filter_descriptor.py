...
parser.add_argument('--k', type=int, default=20,
                    help='Number of descriptors to save after filtering (in order of similarity scores).')
...
def main():
    ...
    filtered_descriptor_path = os.path.join('descriptors', opt.savedir, model_size, f'descriptors_{opt.dataset}' + (
        f'_{opt.seed}' if opt.seed != 0 else '') + '.json')
