...
files = [
    'results_only_descriptor/using_only_descriptor_comparative.csv',
    'results_only_descriptor/using_only_descriptor_dclip.csv',
]
...
with open('output_table_only_descriptor.txt', 'w') as f:
    f.write('\n'.join(table_data))